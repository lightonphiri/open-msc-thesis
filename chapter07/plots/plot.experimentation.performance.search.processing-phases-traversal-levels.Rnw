...
tikz('plot.experimentation.performance.search.processing-phases-traversal-levels.tex', width=5.5, height=3.0)
...
ggplot(data=experimentdataset[experimentdataset$variable=="Traversal",], 
