...
require(reshape2)
require(grid)
tikz('ggplot2-experiments-performance-throughput.tex', width=5.9, height=4.0)
dataset <- read.table("../data/experiments-performance-throughput.dat", header=TRUE, sep=",")
