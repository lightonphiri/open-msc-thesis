...
tikz('plot.experimentation.performance.search.processing-phases-parsing-levels.tex', width=5.5, height=3.0)
...
ggplot(data=experimentdataset[experimentdataset$variable=="Parsing",], 
